...
import { getDiscordCalendar, importDay, listLeadRequests, activateLeadRequest, rejectLeadRequest, markOngoingRequest, resetDayRequests } from "./discord-actions";
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        style={{ background: "#1B2430", color: "#F2B84B", borderLeft: "1px solid #232D3A" }}
                      >
                        {isResetting ? "..." : "↺"}
                      </button>
                    </div>
